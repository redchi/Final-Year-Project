...
<section class="form6 cid-sBmW5EZsPj" id="form6-1o">
    
	
	<div class="container">
        <div class="mbr-section-head">
              <h3 class="mbr-section-title mbr-fonts-style align-center mb-0" mbr-theme-style="display-2" mbr-if="showTitle" data-app-selector=".mbr-section-title"><b>Please enter a new password</b></h3>
            <h4 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2" mbr-theme-style="display-7" mbr-if="showSubtitle" data-app-selector=".mbr-section-subtitle"><div>has to be 6 - 30 characters&nbsp;<br>Have at least 1 lowercase letter<br>Have at least 1 uppercase letter<br>Have at least 1 number</div></h4>
        </div>
