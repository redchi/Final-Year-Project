   ...
   <div class="container">
        <div class="row content-wrapper justify-content-center">
            ...
            <!--  NEEDS INTERMEDIATERY METHOD -->>
                <form action="${pageContext.request.contextPath}/createBot/BollingerAndStochasticFormSubmit" method="GET" class="mbr-form form-with-styler" >
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h1 class="mbr-section-title mb-4 display-2"><strong>Stochastic and Bollinger Strategy</strong></h1>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="col-lg-7 offset-lg-1 col-12">
                <div class="image-wrapper">
                    <img class="w-100" src="${pageContext.request.contextPath}/assets/images/d3-492x457.png" alt="Mobirise">
                </div>
            </div>
        </div>
    </div>
