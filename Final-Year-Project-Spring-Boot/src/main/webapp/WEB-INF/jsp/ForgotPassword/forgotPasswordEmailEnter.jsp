	...
	<div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Please enter your email</strong></h3>
            
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" >
                <form action="${pageContext.request.contextPath}/ForgotPassword/SubmitEmail" method="POST" class="mbr-form form-with-styler mx-auto" >
                    <div class="row">
